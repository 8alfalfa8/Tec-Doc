...
- [1. 全体作業フェーズと構成イメージ](#1-全体作業フェーズと構成イメージ)
  - [移行後の基本アーキテクチャ（例）](#移行後の基本アーキテクチャ例)
- [2. フェーズ別作業タスク一覧](#2-フェーズ別作業タスク一覧)
- [3. 各作業タスクの詳細](#3-各作業タスクの詳細)
  - [① 現行オンプレミス環境調査（最重要）](#①-現行オンプレミス環境調査最重要)
    - [目的](#目的)
    - [必要な入手情報](#必要な入手情報)
    - [作業内容](#作業内容)
    - [成果物](#成果物)
  - [② コンテナ化方針設計](#②-コンテナ化方針設計)
    ...
    - [重要ポイント](#重要ポイント)
    - [成果物](#成果物)
  - [③ Dockerfile作成（Tomcat + WAR）](#③-dockerfile作成tomcat-war)
    - [作業内容](#作業内容)
    - [設定例](#設定例)
    - [成果物](#成果物)
  - [④ AWSインフラ設計](#④-awsインフラ設計)
    ...
    - [ポイント](#ポイント)
    - [成果物](#成果物)
  - [⑤ ECS Task / Service 設計](#⑤-ecs-task-service-設計)
    - [Task定義設定例](#task定義設定例)
    - [設定内容](#設定内容)
    - [成果物](#成果物)
  - [⑥ 外部設定・Secrets移行](#⑥-外部設定secrets移行)
    - [作業内容](#作業内容)
    - [設定例](#設定例)
    - [成果物](#成果物)
  - [⑦ ログ・監視設計](#⑦-ログ監視設計)
