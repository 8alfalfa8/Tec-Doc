...
- [4. 前提条件・制約](#4-前提条件制約)
- [5. 用語定義](#5-用語定義)
- [6. 関係者（RACI）](#6-関係者raci)
- [7. システム構成概要](#7-システム構成概要)
- [8. 非機能要件](#8-非機能要件)
- [9. 転送フロー（シーケンス）](#9-転送フローシーケンス)
- [10. ファイル仕様（例）](#10-ファイル仕様例)
  - [10.1 共通ルール](#101-共通ルール)
  - [10.2 CSV項目例（受注データ）](#102-csv項目例受注データ)
- [11. HULFT設定方針（送信側）](#11-hulft設定方針送信側)
  - [サンプル（HULFT設定概念）](#サンプルhulft設定概念)
- [12. 受信側設計（取引先から受ける場合）](#12-受信側設計取引先から受ける場合)
- [13. エラーハンドリング／再送設計](#13-エラーハンドリング再送設計)
- [14. 監視・通知](#14-監視通知)
- [15. セキュリティ](#15-セキュリティ)
- [16. 運用・作業フロー](#16-運用作業フロー)
  - [日次フロー（例）](#日次フロー例)
  - [定常作業](#定常作業)
- [17. テスト計画（受け入れ条件）](#17-テスト計画受け入れ条件)
  - [テスト項目](#テスト項目)
  - [受入基準（例）](#受入基準例)
- [18. 移行・デプロイ手順（概要）](#18-移行デプロイ手順概要)
- [19. ログ・監査項目（必須）](#19-ログ監査項目必須)
- [20. 例：HULFT転送設定（テンプレ：概念）](#20-例hulft転送設定テンプレ概念)
- [21. 付録（サンプル）](#21-付録サンプル)
  - [A. サンプルCSV（1行）](#a-サンプルcsv1行)
  - [B. エラーメッセージ例](#b-エラーメッセージ例)
- [22. 受け渡し（成果物）](#22-受け渡し成果物)
<!-- TOC_END -->
