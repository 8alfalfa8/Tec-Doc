...
- [版管理](#版管理)
- [6.1 ファイル一覧](#61-ファイル一覧)
- [6.2 ファイル命名規則](#62-ファイル命名規則)
- [6.3 レコード定義（サンプル）](#63-レコード定義サンプル)
  - [注文CSV（ORD）](#注文csvord)
- [7.1 転送方式](#71-転送方式)
- [7.2 ジョブ（Job）設定項目](#72-ジョブjob設定項目)
- [7.3 例：ジョブテンプレート](#73-例ジョブテンプレート)
- [9.1 転送障害（通信断）](#91-転送障害通信断)
- [9.2 ファイル不整合（破損、文字化け）](#92-ファイル不整合破損文字化け)
- [9.3 重複受信対策](#93-重複受信対策)
- [12.1 結合テスト](#121-結合テスト)
- [12.2 運用テスト](#122-運用テスト)
- [12.3 テストデータ](#123-テストデータ)
<!-- TOC_END -->
