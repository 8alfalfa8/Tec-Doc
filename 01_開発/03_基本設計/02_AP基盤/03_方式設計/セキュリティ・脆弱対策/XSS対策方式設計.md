...
- [XSS対策方式設計とは](#xss対策方式設計とは)
- [XSSの種類と影響](#xssの種類と影響)
- [基本設計段階での対策方針](#基本設計段階での対策方針)
  - [1. 入力値のバリデーション (入力時対策)](#1-入力値のバリデーション-入力時対策)
  - [2. エスケープ処理 (出力時対策) - **最重要**](#2-エスケープ処理-出力時対策-最重要)
  - [3. コンテンツセキュリティポリシー (CSP) - 被害軽減策](#3-コンテンツセキュリティポリシー-csp-被害軽減策)
  - [4. クッキーの保護](#4-クッキーの保護)
  - [5. その他の重要な設計方針](#5-その他の重要な設計方針)
- [開発プロセスに組み込む対策](#開発プロセスに組み込む対策)
- [まとめ: 設計で決めるべき重要事項](#まとめ-設計で決めるべき重要事項)
<!-- TOC_END -->
