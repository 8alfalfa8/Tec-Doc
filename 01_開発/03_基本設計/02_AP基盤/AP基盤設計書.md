...
- [1. 目的・適用範囲](#1-目的適用範囲)
- [2. 要件（抜粋）](#2-要件抜粋)
- [3. 基本方針（設計原則）](#3-基本方針設計原則)
- [4. 全体アーキテクチャ（論理）](#4-全体アーキテクチャ論理)
- [5. コンポーネント設計（主要要素）](#5-コンポーネント設計主要要素)
  - [5.1 エッジ（公開）](#51-エッジ公開)
  - [5.2 ネットワーク](#52-ネットワーク)
  - [5.3 ロードバランサ](#53-ロードバランサ)
  - [5.4 実行基盤（アプリ層）](#54-実行基盤アプリ層)
  - [5.5 ミドルウェア](#55-ミドルウェア)
  - [5.6 データベース連携](#56-データベース連携)
  - [5.7 永続ストレージ](#57-永続ストレージ)
  - [5.8 CI/CD](#58-cicd)
  - [5.9 ログ・監視・トレーシング（可観測性）](#59-ログ監視トレーシング可観測性)
  - [5.10 セキュリティ](#510-セキュリティ)
- [6. 非機能要件（NFR）具体化](#6-非機能要件nfr具体化)
- [7. 運用・保守設計](#7-運用保守設計)
  - [7.1 運用体制](#71-運用体制)
  - [7.2 モニタリング＆ダッシュボード](#72-モニタリングダッシュボード)
  - [7.3 ログ管理](#73-ログ管理)
  - [7.4 バックアップとリストア](#74-バックアップとリストア)
  - [7.5 障害対応（Runbook）](#75-障害対応runbook)
- [8. セキュリティ設計詳細](#8-セキュリティ設計詳細)
- [9. デプロイ・リリース設計](#9-デプロイリリース設計)
- [10. DR（Disaster Recovery）設計](#10-drdisaster-recovery設計)
- [11. コスト／キャパシティ計画](#11-コストキャパシティ計画)
- [12. 運用ドキュメント・成果物](#12-運用ドキュメント成果物)
- [13. リスクと対応策（抜粋）](#13-リスクと対応策抜粋)
- [14. 設計レビュー／承認](#14-設計レビュー承認)
- [15. チェックリスト（短縮版）](#15-チェックリスト短縮版)
<!-- TOC_END -->
