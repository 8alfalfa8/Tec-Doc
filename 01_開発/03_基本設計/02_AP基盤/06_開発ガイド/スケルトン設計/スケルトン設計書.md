...
- [4. コアコンポーネント設計](#4-コアコンポーネント設計)
  - [4.1 アプリケーション設定](#41-アプリケーション設定)
  - [4.2 RESTコントローラ例](#42-restコントローラ例)
  - [4.3 サービス層設計](#43-サービス層設計)
  - [4.4 リポジトリ層設計](#44-リポジトリ層設計)
- [5. 共通機能設計](#5-共通機能設計)
  - [5.1 例外処理](#51-例外処理)
  - [5.2 ロギング設計](#52-ロギング設計)
- [6. 設定ファイル例](#6-設定ファイル例)
...
- [8. デプロイ設計](#8-デプロイ設計)
  - [8.1 コンテナ化](#81-コンテナ化)
  - [8.2 CI/CDパイプライン](#82-cicdパイプライン)
- [9. セキュリティ設計](#9-セキュリティ設計)
  - [9.1 セキュリティ設定例](#91-セキュリティ設定例)
- [10. 監視・運用設計](#10-監視運用設計)
  - [10.1 ヘルスチェック](#101-ヘルスチェック)
  - [10.2 メトリクス収集](#102-メトリクス収集)
- [1. プロジェクト拡張概要](#1-プロジェクト拡張概要)
  - [1.1 目的](#11-目的)
  - [1.2 適用範囲](#12-適用範囲)
- [2. プロジェクト構造拡張](#2-プロジェクト構造拡張)
  - [2.1 ディレクトリ構成追加](#21-ディレクトリ構成追加)
- [3. 技術スタック追加](#3-技術スタック追加)
  - [3.1 追加技術](#31-追加技術)
- [4. JSP対応設定](#4-jsp対応設定)
  - [4.1 依存関係追加 (pom.xml)](#41-依存関係追加-pomxml)
  - [4.2 設定ファイル追加 (application.yml)](#42-設定ファイル追加-applicationyml)
- [5. Webコントローラ設計](#5-webコントローラ設計)
  - [5.1 基本コントローラ例](#51-基本コントローラ例)
  - [5.2 フォームクラス例](#52-フォームクラス例)
- [6. JSP実装例](#6-jsp実装例)
  - [6.1 基本テンプレート (layout.jsp)](#61-基本テンプレート-layoutjsp)
  - [6.2 ユーザー一覧画面 (list.jsp)](#62-ユーザー一覧画面-listjsp)
  - [6.3 ユーザー登録画面 (create.jsp)](#63-ユーザー登録画面-createjsp)
- [7. セキュリティ拡張](#7-セキュリティ拡張)
  - [7.1 Webセキュリティ設定](#71-webセキュリティ設定)
  - [7.2 ログインコントローラ](#72-ログインコントローラ)
- [8. 国際化対応](#8-国際化対応)
  - [8.1 メッセージプロパティ (messages.properties)](#81-メッセージプロパティ-messagesproperties)
  - [8.2 ロケールリゾルバ設定](#82-ロケールリゾルバ設定)
- [9. テスト拡張](#9-テスト拡張)
  - [9.1 Web MVCテスト例](#91-web-mvcテスト例)
- [10. 注意事項](#10-注意事項)
<!-- TOC_END -->
