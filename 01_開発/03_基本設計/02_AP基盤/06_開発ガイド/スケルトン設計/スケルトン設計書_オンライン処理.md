...
- [3. 共通ベースクラス設計](#3-共通ベースクラス設計)
  - [3.1 ベースコントローラー (`BaseController`)](#31-ベースコントローラー-basecontroller)
  - [3.2 ベースサービス (`BaseService`)](#32-ベースサービス-baseservice)
  - [3.3 ベースリポジトリ (`BaseRepository`)](#33-ベースリポジトリ-baserepository)
- [4. 共通機能実装](#4-共通機能実装)
  - [4.1 グローバル例外ハンドラ](#41-グローバル例外ハンドラ)
  - [4.2 ロギング設定](#42-ロギング設定)
- [5. 業務機能実装例 (ユーザー管理)](#5-業務機能実装例-ユーザー管理)
  - [5.1 ユーザーコントローラー](#51-ユーザーコントローラー)
  - [5.2 ユーザーサービス](#52-ユーザーサービス)
- [6. 設定クラス](#6-設定クラス)
  - [6.1 Web設定](#61-web設定)
  - [6.2 データベース設定](#62-データベース設定)
- [7. 適用技術スタック](#7-適用技術スタック)
- [1. 設計方針](#1-設計方針)
- [2. プロジェクト構成](#2-プロジェクト構成)
- [3. 基底コントローラ設計](#3-基底コントローラ設計)
  - [3.1 BaseController.java](#31-basecontrollerjava)
- [4. 業務コントローラ実装例](#4-業務コントローラ実装例)
  - [4.1 SampleController.java](#41-samplecontrollerjava)
- [5. 基底サービス設計](#5-基底サービス設計)
  - [5.1 BaseService.java](#51-baseservicejava)
  - [5.2 BaseServiceImpl.java](#52-baseserviceimpljava)
- [6. 共通例外処理](#6-共通例外処理)
  - [6.1 GlobalExceptionHandler.java](#61-globalexceptionhandlerjava)
- [7. 共通AOP処理](#7-共通aop処理)
  - [7.1 LoggingAspect.java](#71-loggingaspectjava)
- [8. JSP共通レイアウト](#8-jsp共通レイアウト)
  - [8.1 layout.jsp](#81-layoutjsp)
- [9. 設定クラス](#9-設定クラス)
  - [9.1 WebMvcConfig.java](#91-webmvcconfigjava)
- [10. 実装ガイドライン](#10-実装ガイドライン)
- [プロジェクト構成](#プロジェクト構成)
- [主要な変更点](#主要な変更点)
  - [1. パッケージ構造の明確化](#1-パッケージ構造の明確化)
  - [2. 業務機能パッケージの標準構造](#2-業務機能パッケージの標準構造)
  - [3. 基底コントローラ (BaseController.java)](#3-基底コントローラ-basecontrollerjava)
  - [4. 業務コントローラ実装例 (UserController.java)](#4-業務コントローラ実装例-usercontrollerjava)
  - [5. 基底サービス (BaseService.java)](#5-基底サービス-baseservicejava)
- [この構成の利点](#この構成の利点)
<!-- TOC_END -->
...
### 3. 基底コントローラ (BaseController.java)
