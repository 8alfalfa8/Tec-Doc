...
実務で本当に使うGitコマンドだけを厳選したハンズオンを用意しました。**「とりあえず開発現場で困らない」** ことを目標としています。

## 前提
- Github[^1]はユーザ登録済みとします。
- Git[^2]はインストール済みとします。
- ターミナル（コマンドプロンプト）で操作します。

[^1]:[Github](https://github.com/)よりユーザを登録する。
[^2]:[Git](https://git-scm.com/)より入手してインストールする。
